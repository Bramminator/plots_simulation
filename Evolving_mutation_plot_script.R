...
Population_frame <- readRDS('~/R/evolving_mutation_100wt_popframe.rds')
...
Population_frame %>%
  ...
  ggsave('~/Documents/strepto/evolving_mutation_100wt_plots/popsize_05cycle.png',
         height = 210,
         width  = 297,
         units= 'mm',
         dpi= 150)
...
Population_frame %>%
  ...
  ggsave('~/Documents/strepto/evolving_mutation_100wt_plots/popsize_075cycle.png',
         height = 210,
         width  = 297,
         units= 'mm',
         dpi= 150)
...
Population_frame %>%
  ...
  ggsave('~/Documents/strepto/evolving_mutation_100wt_plots/popsize_025cycle.png',
         height = 210,
         width  = 297,
         units= 'mm',
         dpi= 150)
...
costs_frame <- readRDS('~/R/evolving_mutation_100wt_costframe.rds')
...
ggsave('~/Documents/strepto/evolving_mutation_100wt_plots/costs_axis.png',
       height = 210,
       width  = 297,
       units= 'mm',
       dpi= 150)
...
ggsave('~/Documents/strepto/evolving_mutation_100wt_plots/mutation_rate.png',
       height = 210,
       width  = 297,
       units= 'mm',
       dpi= 150)
...
costs_frame %>% 
  ...
  ggsave('~/Documents/strepto/evolving_mutation_100wt_plots/production.png',
         height = 210,
         width  = 297,
         units= 'mm',
         dpi= 150)
